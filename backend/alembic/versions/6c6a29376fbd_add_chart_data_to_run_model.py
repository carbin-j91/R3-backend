"""Add chart_data to Run model

Revision ID: 6c6a29376fbd
Revises: 10dd7753a1f2
Create Date: 2025-09-04 08:58:06.780942
...
revision: str = '6c6a29376fbd'
down_revision: Union[str, Sequence[str], None] = '10dd7753a1f2'
...
def upgrade() -> None:
    ...
    op.add_column('runs', sa.Column('chart_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('runs', 'chart_data')
