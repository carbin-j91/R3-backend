"""Expand run model with detailed stats

Revision ID: d8c661aa71d8
Revises: ebc3a0c822ec
Create Date: 2025-08-28 11:54:17.706489
...
revision: str = 'd8c661aa71d8'
down_revision: Union[str, Sequence[str], None] = 'ebc3a0c822ec'
...
def upgrade() -> None:
    ...
    op.add_column('runs', sa.Column('calories_burned', sa.Float(), nullable=True))
    op.add_column('runs', sa.Column('avg_heart_rate', sa.Integer(), nullable=True))
    op.add_column('runs', sa.Column('avg_cadence', sa.Integer(), nullable=True))
    op.add_column('runs', sa.Column('total_elevation_gain', sa.Float(), nullable=True))
    op.add_column('runs', sa.Column('splits', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
...
def downgrade() -> None:
    ...
    op.alter_column('users', 'email',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.drop_column('runs', 'splits')
    op.drop_column('runs', 'total_elevation_gain')
    op.drop_column('runs', 'avg_cadence')
    op.drop_column('runs', 'avg_heart_rate')
    op.drop_column('runs', 'calories_burned')
